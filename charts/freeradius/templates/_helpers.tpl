...
{{/*
Name of the Kubernetes Secret that holds DB and RADIUS credentials.
When externalSecret is enabled, ESO creates it; otherwise it must exist externally.
*/}}
{{- define "freeradius.credentialsSecretName" -}}
{{- default (printf "%s-credentials" (include "freeradius.fullname" .)) .Values.externalSecret.secretName }}
{{- end }}